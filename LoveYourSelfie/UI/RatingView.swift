...
open class RatingView: UIView {
    ...
    func customInit() {
        ...
        if offImage == nil {
            offImage = UIImage(named: "starEmpty", in: bundle, compatibleWith: self.traitCollection)
        }
        if onImage == nil {
            onImage = UIImage(named: "starFull", in: bundle, compatibleWith: self.traitCollection)
        }
        
        if halfImage == nil {
            halfImage = UIImage(named: "starHalf", in: bundle, compatibleWith: self.traitCollection)
        }
